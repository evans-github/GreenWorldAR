...
public class AnimalsGridAdapter extends RecyclerView.Adapter<AnimalsGridAdapter.ViewHolder> {
    ...
    public AnimalsGridAdapter(Context mContext, ArrayList<String> mImages, ArrayList<String> mTreeNames) {
