...
public class ARTreeGridAdapter extends RecyclerView.Adapter<ARTreeGridAdapter.ViewHolder> {
    ...
    public ARTreeGridAdapter(Context mContext, ArrayList<String> mImages, ArrayList<String> mTreeNames) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (fragmentHome != null) {
                switch (mPosition){
                    case 4:
                        fragmentHome.setLemonTreeModel();
                        fragmentHome.dismissRealTreeMenu();
                        break;
